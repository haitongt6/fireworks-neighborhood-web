<template>
  <div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative bg-gray-900 overflow-hidden">
      ...
      <div class="absolute inset-0 bg-gradient-to-br from-orange-500/50 to-red-600/80 mix-blend-multiply"></div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center bg-gray-50 px-8 sm:px-16">
      <div class="w-full max-w-md space-y-8">
        <div class="text-center lg:text-left">
          <div class="lg:hidden w-12 h-12 bg-gradient-to-br from-orange-400 to-red-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-red-200 mx-auto mb-6">
          ...
          <p class="text-sm text-gray-500 mt-2">请输入您的账号和密码登录管理系统</p>
        </div>
        ...
        <form class="mt-8 space-y-6" @submit.prevent="handleLogin">
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input 
                  ...
                  type="text" 
                  required
                  class="block w-full pl-11 pr-4 py-3.5 border border-gray-200 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all bg-white shadow-sm"
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <input id="remember-me" type="checkbox" class="h-4 w-4 text-orange-500 focus:ring-orange-500 border-gray-300 rounded cursor-pointer">
              <label for="remember-me" class="ml-2 block text-sm text-gray-600 cursor-pointer">
                记住我
              </label>
            </div>
            <div class="text-sm">
              <a href="#" class="font-bold text-orange-600 hover:text-orange-500 transition-colors">忘记密码？</a>
            </div>
          </div>
          ...
          <button 
            type="submit"
            :disabled="loading"
            class="w-full flex justify-center py-3.5 px-4 border border-transparent rounded-2xl shadow-lg shadow-orange-200/50 text-sm font-bold text-white bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-all transform hover:-translate-y-0.5 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0"
          >
            {{ loading ? '登录中...' : '登 录' }}
          </button>
        </form>
